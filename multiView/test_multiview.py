...
from modules.losses import chamfer_loss_img
...
params.name = params.category + '_multi_view_3'
params.pretrainNet = 'aero_multi_view_3'
params.pretrainIter = 999
...
test_dataloader = ShapeNetMultiViewDataset(params, 'test')
